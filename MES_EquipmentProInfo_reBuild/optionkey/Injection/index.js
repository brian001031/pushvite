                ...
                <div className="LeftContent">
                        ...
                        >
                          {
                            shiftClass === "早班" ? (
                                <div>
                                    {leftData?.staffRows?.[0]?.OPNO || "抓取中"}| {leftData?.staffRows?.[0]?.StaffName1 || "抓取中"}
                                </div>
                            ): (
                                <div>
                                    {leftData?.staffRows?.[1]?.OPNO || "抓取中"}| {leftData?.staffRows?.[1]?.StaffName2 || "抓取中"}
                                </div>
                            )
                        }
                        </div>
                    ...
                    <div className="Content">●生產量:</div>
                        ...
                        {   
                            ...
                            >
                                累積產能 :
                                {leftData?.selectedDayCapacity_first_result} PCS
                            </div>
                            ) : (
