...
import { group_capacity_record } from "../../../../mes_remak_data";
    ...
    const [startDate, setStartDate] = useState(moment().locale("zh-tw"));
      ...
      useEffect(() => {
        ...
        const fetchQuality = async () => {
          ...
          try {
            ...
            const response = await api?.callcapacity_groupname_capacitynum(
              machineOption,
              startDate
            );
      ...
      const fetchData = async () => {
        try {
            ...
            const response = await api?.callcapacity(machineOption , startDate || "");
            console.log("API回傳 callcapacity:", response);
            if (response?.length) {
      ...
      const varName = String("group_capacity_record").trim();
            ...
            <Col lg={3} md={3} sm={12} style={{ minWidth: 300 }}>
              <div className="LeftContent">
                <div className="Content_Top">
                  ...
                  {startDate &&
                  leftData?.amountCapacity_first_result !== null ? (
                    <div
                      className="Answer"
            ...
            <Col lg={5} md={5} sm={12} style={{ minWidth: 600 }}>
              <div className="MiddleContent">
                <div className="Content_Top">
                  ...
                  >
                    {Object.keys(group_capacity_record).map((groupName) => {
                      const labelMap = group_capacity_record[groupName]?.[0] || {};
