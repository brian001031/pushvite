    ...
    return (
        <div style={{ maxWidth: "100vw", overflowX: "auto" }}>
            ...
            >
                ...
                <option value="真空電芯-大烘箱/極片-小烘箱">真空電芯-大烘箱/極片-小烘箱</option>
                ...
                <Col lg={3} md={3} sm={12} style={{ minWidth: 300 }}>
                    <div className="LeftContent">
                        <div className="Content_Top" >
                            ...
                            <div className="Answer" style={getColorStyle('cellNO')}>{responseData.Machine || "抓取中"} </div>
                            ...
                            <div className="Answer">
                                <div className= "AnswerEquipment" style={getColorStyle('CurrentEdgeOP')}>{responseData.OP || "抓取中"}|{responseData.OPName || "抓取中"}</div>
                            </div>
                            <div className="Content">●目前工單號:</div>
                            <div className="Answer" style={getColorStyle('stageID')}>{responseData.WO || "抓取中"}</div>
                ...
                <Col lg={5} md={5} sm={12} style={{ minWidth: 600 }}>
                    <div className="MiddleContent">
                        <div className="Content_Top">
                            ...
                            <div className="DataBack" style={{width: "100%" ,  overflow: "scroll"}}>
