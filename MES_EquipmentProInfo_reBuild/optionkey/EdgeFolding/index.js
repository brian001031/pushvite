...
const EdgeFolding = () => {
  ...
  useEffect(() => {
    ...
    if (responseData?.CurrentEdgeOP) {
      const op = String(responseData.CurrentEdgeOP).padStart(3, "0");
      setEquipmentID(op);
    } else {
        ...
        <Col lg={3} md={3} sm={12} style={{ minWidth: 300 }}>
          <div className="LeftContent">
            <div className="Content_Top">
              ...
              <div className="Answer" style={getColorStyle("Time")}>
                累積產能 :{responseDataQuality.score || "抓取中"} PCS{" "}
              </div>
              ...
              <div className="Answer" style={getColorStyle("score")}>
                {responseDataQuality.code || "抓取中"} PCS
              </div>
        ...
        <Col lg={5} md={5} sm={12} style={{ minWidth: 600 }}>
          <div className="MiddleContent">
            <div className="Content_Top">
              ...
              >
                {Object.keys(change_edge_field).map((groupName) => {
                  const labelMap = change_edge_field[groupName]?.[0] || {};
