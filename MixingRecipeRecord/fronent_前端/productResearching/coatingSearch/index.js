...
const HandOver = React.lazy(() => import('./handOver.tsx'));
...
const CoatingSearch = () => {
    ...
    const changeTitle = () =>{
        if (isSmallScreen){
            ...
            return (
                <>
                    <FormattedMessage id="scrollingResearching.dayReport.title" defaultMessage="塗佈生產查詢表" />
                </>
            )
        }
    }
                        ...
                        <div style={{ flex: "0 0 33%" }}>
                            <Form.Control as="select" value={option} onChange={(e) => setOption(e.target.value)}>
                                ...
                                <option value="handOver">
                                    <FormattedMessage id="scrollingResearching.switchBar.Detailed" defaultMessage="換班交接" />
                                </option>
                            </Form.Control>
                        </div>
